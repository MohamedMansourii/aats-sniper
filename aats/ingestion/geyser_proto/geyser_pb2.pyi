...
class SubscribeRequestFilterAccounts(_message.Message):
    __slots__ = ("account", "owner", "filters", "no_tx_metadata")
    ACCOUNT_FIELD_NUMBER: _ClassVar[int]
    OWNER_FIELD_NUMBER: _ClassVar[int]
    FILTERS_FIELD_NUMBER: _ClassVar[int]
    NO_TX_METADATA_FIELD_NUMBER: _ClassVar[int]
    ...
    no_tx_metadata: bool
    def __init__(self, account: _Optional[_Iterable[str]] = ..., owner: _Optional[_Iterable[str]] = ..., filters: _Optional[_Iterable[_Union[SubscribeRequestFilterAccountsFilter, _Mapping]]] = ..., no_tx_metadata: bool = ...) -> None: ...

class SubscribeRequestFilterAccountsFilter(_message.Message):
    __slots__ = ("memcmp", "data_size", "token_account_state")
    ...
    def __init__(self, memcmp: _Optional[_Union[SubscribeRequestFilterAccountsFilterMemcmp, _Mapping]] = ..., data_size: _Optional[int] = ..., token_account_state: bool = ...) -> None: ...
...
class SubscribeUpdateSlot(_message.Message):
    ...
    def __init__(self, slot: _Optional[int] = ..., parent: _Optional[int] = ..., status: _Optional[_Union[CommitmentLevel, str]] = ...) -> None: ...

class SubscribeUpdateBlockMeta(_message.Message):
    __slots__ = ("parent_slot", "parent_blockhash", "slot", "blockhash", "rewards", "block_time", "block_height", "executed_transaction_count", "entries_count")
    ...
    slot: int
    blockhash: str
    rewards: _containers.RepeatedCompositeFieldContainer[_solana_storage_pb2.Reward]
    block_time: _solana_storage_pb2.UnixTimestamp
    block_height: _solana_storage_pb2.BlockHeight
    executed_transaction_count: int
    entries_count: int
    def __init__(self, parent_slot: _Optional[int] = ..., parent_blockhash: _Optional[str] = ..., slot: _Optional[int] = ..., blockhash: _Optional[str] = ..., rewards: _Optional[_Iterable[_Union[_solana_storage_pb2.Reward, _Mapping]]] = ..., block_time: _Optional[_Union[_solana_storage_pb2.UnixTimestamp, _Mapping]] = ..., block_height: _Optional[_Union[_solana_storage_pb2.BlockHeight, _Mapping]] = ..., executed_transaction_count: _Optional[int] = ..., entries_count: _Optional[int] = ...) -> None: ...

class SubscribeUpdateBlock(_message.Message):
    __slots__ = ("parent_slot", "parent_blockhash", "slot", "blockhash", "rewards", "block_time", "block_height", "transactions", "executed_transaction_count", "entries", "entries_count")
    PARENT_SLOT_FIELD_NUMBER: _ClassVar[int]
    PARENT_BLOCKHASH_FIELD_NUMBER: _ClassVar[int]
    SLOT_FIELD_NUMBER: _ClassVar[int]
    BLOCKHASH_FIELD_NUMBER: _ClassVar[int]
    ...
    entries_count: int
    def __init__(self, parent_slot: _Optional[int] = ..., parent_blockhash: _Optional[str] = ..., slot: _Optional[int] = ..., blockhash: _Optional[str] = ..., rewards: _Optional[_Iterable[_Union[_solana_storage_pb2.Reward, _Mapping]]] = ..., block_time: _Optional[_Union[_solana_storage_pb2.UnixTimestamp, _Mapping]] = ..., block_height: _Optional[_Union[_solana_storage_pb2.BlockHeight, _Mapping]] = ..., transactions: _Optional[_Iterable[_Union[SubscribeUpdateTransactionInfo, _Mapping]]] = ..., executed_transaction_count: _Optional[int] = ..., entries: _Optional[_Iterable[_Union[SubscribeUpdateEntry, _Mapping]]] = ..., entries_count: _Optional[int] = ...) -> None: ...
